...
public class StudentDAOImpl implements StudentDAO {
	...
	public List<StudentCourseDTO> getStudentCoursesByStudentId(Student student) throws DataServiceException {
		...
		try {
			StringBuilder sb = new StringBuilder(
					"SELECT student_id studentId,course_id courseId,course_name courseName,description description,status_id statusId FROM vw_student_course WHERE student_id="
							+ student.getId());
	...
	public List<StudentProjectDTO> getStudentProjectsByStudentId(Student student) throws DataServiceException {
		...
		try {
			StringBuilder sb = new StringBuilder(
					"SELECT student_id studentId,project_id projectId,project_name projectName,description description,status_id statusId FROM vw_student_project WHERE student_id="
							+ student.getId());
...
/*	
	...
	public List<StudentDTO> getOverAllStudentByCurrentCourses(Student student) throws DataServiceException {
		...
		try {
			...
			overAllStudentByCurrentCourses = dataRetriver.retrieveBySQLAsJSON(sb.toString(), StudentDTO.class);
	...
	public List<StudentDTO> getOverAllStudentByCompletedCourses(Student student) throws DataServiceException {
		...
		try {
			...
			overAllStudentByCompletedCourses = dataRetriver.retrieveBySQLAsJSON(sb.toString(), StudentDTO.class);
	...
	public List<StudentDTO> getOverAllStudentByCurrentProjects(Student student) throws DataServiceException {
		...
		try {
			...
			overAllStudentByCurrentProjects = dataRetriver.retrieveBySQLAsJSON(sb.toString(), StudentDTO.class);
	...
	public List<StudentDTO> getAllStudentByCollege(Student student) throws DataServiceException {
		...
		try {
			if (student.getDepartment().getId() == 5) {
				...
				overAllStudentByCollege = dataRetriver.retrieveBySQLAsJSON(sb.toString(), StudentDTO.class);
				logger.info("Over All Student By Completed Projects data retrieval success..");
			} else {
