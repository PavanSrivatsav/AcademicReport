...
*/
	...
	public List<StudentDTO> getAllStudentByCollege(Student student) throws DataServiceException {
		...
		try {
			StringBuilder sb = new StringBuilder(
					"SELECT id id,NAME name,department_id departmentId,college_id collegeId,department_name departmentName,email_id emailId,current_courses_name currentCourse,completed_courses_name completedCourse,current_projects_name currentProject,completed_projects_name completedProject FROM vw_overall_student_list WHERE college_id="
